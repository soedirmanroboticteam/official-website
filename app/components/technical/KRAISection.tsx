...
import { kraiTeam } from "@/lib/technicalSection/kraiTeam";
import Image from 'next/image';

const KRAISection = () => {
  return (
    <section className="w-3/4 flex flex-wrap md:flex-row justify-center items-center py-6">
        <div className="w-full text-center font-bold text-2xl md:text-4xl font-poppins pb-8">Blakasutha</div>
        {kraiTeam.map((member, index) => (
