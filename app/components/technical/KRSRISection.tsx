...
import { krsriTeam } from "@/lib/technicalSection/krsriTeam";
import Image from 'next/image';

const KRSRISection = () => {
  return (
    <section className="w-3/4 flex flex-wrap md:flex-row justify-center items-center py-6">
        <div className="w-full text-center font-bold text-2xl md:text-4xl font-poppins pb-8">Satria</div>
        {krsriTeam.map((member, index) => (
