...
import { bphTeam } from "@/lib/managementSection/bphTeam";
import Image from 'next/image';

const BPHSection = () => {
  return (
    <section className="w-3/4 flex flex-wrap md:flex-row justify-center items-center py-6">
        <div className="w-full text-center font-bold text-2xl md:text-4xl font-poppins pb-8">BPH</div>
        {bphTeam.map((member, index) => (
