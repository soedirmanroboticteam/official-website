...
const HeroGallery = () => {
  return (
    <div className="w-svw md:w-full h-[424px] flex flex-row gap-2 md:gap-5 rounded-3xl overflow-hidden">
      <div className="basis-64 md:basis-1/6 md:hover:basis-2/6 rounded-xl bg-white">
        <Image
          src={image1}
          alt=""
      ...
      <div className="hidden md:block md:basis-1/6 md:hover:basis-2/6 rounded-xl bg-white">
        <Image
          src={image5}
          alt=""
          className="w-full h-full object-cover rounded-xl"
